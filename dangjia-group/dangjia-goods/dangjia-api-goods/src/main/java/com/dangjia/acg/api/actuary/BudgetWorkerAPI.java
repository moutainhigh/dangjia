...
public interface BudgetWorkerAPI {
	 ...
	 ServerResponse getBudgetWorkerById(@RequestParam("request") HttpServletRequest request,@RequestParam("id")String id);
	 /**
	 ...
	 ServerResponse getAllBudgetWorkerById(@RequestParam("request") HttpServletRequest request,@RequestParam("houseId")String houseId, @RequestParam("workerTypeId")String workerTypeId );
	 /**
	  * 获取所有人工商品
	  * @return
	  */
	 ...
	 ServerResponse budgetTemplates(@RequestParam("request") HttpServletRequest request,@RequestParam("listOfGoods")String listOfGoods,@RequestParam("workerTypeId")String workerTypeId
	 ...
	 ServerResponse updateBudgetTemplates(@RequestParam("request") HttpServletRequest request, @RequestParam("listOfGoods")String listOfGoods,
												 @RequestParam("workerTypeId")String workerTypeId, @RequestParam("templateId")String templateId);
	 /**
	  * 查询该风格下所有精算模板
	  * @param templateId
	  * @return
	 ...
	 ServerResponse getAllbudgetTemplates(@RequestParam("request") HttpServletRequest request,@RequestParam("templateId")String templateId);
	 /**
	  * 使用精算
	  * @param id
	  * @return
	 ...
	 ServerResponse useTheBudget(@RequestParam("request") HttpServletRequest request,@RequestParam("id")String id);
	 /**
	  * 生成精算
	  * @param houseId
	  * @param workerTypeId
	...
	ServerResponse makeBudgets(@RequestParam("request") HttpServletRequest request, @RequestParam("actuarialTemplateId")String actuarialTemplateId ,
							   @RequestParam("houseId")String houseId, @RequestParam("workerTypeId")String workerTypeId,
