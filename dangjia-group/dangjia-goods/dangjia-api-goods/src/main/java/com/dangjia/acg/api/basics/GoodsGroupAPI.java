...
public interface GoodsGroupAPI {
	...
	public ServerResponse<PageInfo>  getAllList(@RequestParam("pageDTO") PageDTO pageDTO,@RequestParam("name") String name,
	...
	public ServerResponse deleteGoodsGroupById(@RequestParam("goodsGroupId")String goodsGroupId);
