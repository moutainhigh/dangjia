...
public interface IBasicsProductTemplateMapper extends Mapper<DjBasicsProductTemplate> {
   ...
   // void deleteProductWorker(@Param("goodsId") String goodsId);
    ...
    List<ActuarialProductAppDTO> serchCategoryProduct(@Param("cityId") String cityId,@Param("categoryId") String categoryId,@Param("goodsId") String goodsId ,@Param("name")String[]   name, @Param("brandVal") String[] brandVal, @Param("attributeVal") String[] attributeVal, @Param("orderKey") String orderKey);
