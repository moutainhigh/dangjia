 ...
 */
@Repository
public interface IMasterTechnologyMapper extends Mapper<Technology> {
     ...
     * 管家巡查验收工艺
     */
    List<Technology> patrolList(@Param("technologyIds") String technologyIds);

    List<Technology> workerPatrolList(@Param("technologyIds") String technologyIds);
