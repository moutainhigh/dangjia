...
public class HouseUtil {
	 ...
	 * @return
	 */
	public static Map<String, Object> getBudgetDatas(int budgetOk) {
	 ...
	 * @return
	 */
	public static Map<String, Object> getDesignDatas(int decorationType,int designerOk) {
		Map<String, Object> dataMap = new HashMap<>();
		List<Map<String, Object>> dataList = new ArrayList<>();
		String[] nameBs;
		if (decorationType == 2) {//自带设计流程
			dataMap.put("total", 4);
