...
public class RepairMendOrderService {
    ...
    //生成退款的流水记录(直接退款的）
    public ServerResponse saveRefundInfoRecord(String cityId,String houseId,String orderId,String orderProductAttr){
        ...
        if(orderId!=null&&StringUtils.isNotBlank(orderId)) {
                ...
                agreeRepairApplication(mendOrder.getId());//自动同意退款申诉
        }
     ...
     */
    public ServerResponse agreeRepairApplication(String repairMendOrderId){
        ...
        settleMendOrder(repairMendOrderId);//退钱给业主
