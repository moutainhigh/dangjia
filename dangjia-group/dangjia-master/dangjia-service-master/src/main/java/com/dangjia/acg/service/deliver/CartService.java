...
public class CartService {
    ...
    public ServerResponse askAndQuit(HttpServletRequest request, String userToken, PageDTO pageDTO, String houseId, String categoryId, String name) {
        try {
            ...
            PageInfo pageResult = productAPI.queryProductData(house.getCityId(), pageDTO.getPageNum(), pageDTO.getPageSize(), name, categoryId, productType, productIdArr);
            ...
            for (JSONObject product : products) {
                ...
                if (warehouse != null) {
                    Goods goods = forMasterAPI.getGoods(house.getCityId(), String.valueOf(product.get(Product.GOODS_ID)));
                    if (goods != null) {
    ...
    public ServerResponse queryGoodsCategory(HttpServletRequest request, String userToken, String houseId) {
        ...
        for (String categoryId : orderCategory) {
            GoodsCategory goodsCategory = goodsCategoryAPI.getGoodsCategory(house.getCityId(), categoryId);
            if (goodsCategory != null) {
                GoodsCategory goodsCategorytop = goodsCategoryAPI.getGoodsCategory(house.getCityId(), goodsCategory.getParentTop());
