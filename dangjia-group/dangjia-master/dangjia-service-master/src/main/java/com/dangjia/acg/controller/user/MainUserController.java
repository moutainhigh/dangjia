...
//		SessionUtils.setSession("sysSource",source);
	 ...
	 * @return ok/fail
	 */
	@Override @ApiMethod public ServerResponse setJobUser(HttpServletRequest request, String id, boolean isJob) {
	 ...
	 * @return ok/fail
	 */
	@Override @ApiMethod public ServerResponse setUser(HttpServletRequest request,String roleIds, MainUser user) {
	 ...
	 * @return ok/fail
	 */
	@Override @ApiMethod public ServerResponse delUser(HttpServletRequest request, String id) {
	 ...
	 * @return
	 */
	@Override @ApiMethod public ServerResponse recoverUser(HttpServletRequest request,String id) {
	 ...
	 * @return map
	 */
	@Override @ApiMethod public ServerResponse getUserAndRoles(HttpServletRequest request,String id) {
	 ...
	 * @return
	 */
	@Override @ApiMethod public ServerResponse login(HttpServletRequest request,
