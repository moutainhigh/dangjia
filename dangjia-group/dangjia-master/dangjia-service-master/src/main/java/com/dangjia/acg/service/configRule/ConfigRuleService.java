...
public class ConfigRuleService {
    ...
    public ServerResponse getConfigRuleModule(String moduleId,String typeId) {
        try {
            ...
            String batchCode=CommonUtil.getUniqueId();
            if(configRuleModule.getItemType()==1){
                ...
                for (DjConfigRuleRank configRuleRank : configRuleRanks) {
                    ...
                    map.put(DjConfigRuleModule.TYPE_ID,typeId);
