...
public interface MainAuthAPI {
    ...
    * 添加权限【test】
    ...
    @ApiOperation(value = "返回待业主支付精算列表", notes = "返回待业主支付精算列表")
     ServerResponse addPermission(@RequestParam("request") HttpServletRequest request,@RequestParam("permission") Permission permission) ;
    ...
    ServerResponse setPerm(@RequestParam("request") HttpServletRequest request,
            @RequestParam("type") int type, @RequestParam("permission")Permission permission);
    /**
     * 获取权限
     * @param id
     * @return
    ...
    ServerResponse getPerm(@RequestParam("request") HttpServletRequest request,@RequestParam("id") String id) ;
    ...
    ServerResponse addRole(@RequestParam("request") HttpServletRequest request,@RequestParam("permIds") String permIds, @RequestParam("role") Role role);
    /**
     * 根据id查询角色
     * @return PermTreeDTO
     */
    ...
    ServerResponse updateRole(@RequestParam("request") HttpServletRequest request,@RequestParam("id") String id);
    ...
    ServerResponse setRole(@RequestParam("request") HttpServletRequest request,@RequestParam("rolePermIds") String permIds, @RequestParam("role") Role role);
    /**
     * 删除角色以及它对应的权限
     * @param id
     * @return
