...
public interface ProductChangeAPI {
    ...
    ServerResponse insertProductChange(HttpServletRequest request, String userToken, String houseId, String categoryId, String srcProductId, String destProductId, Double srcSurCount);
    ...
    ServerResponse setDestSurCount(HttpServletRequest request, String id, Double destSurCount);
