...
public interface WebMemberAPI {
    ...
    ServerResponse setMember(@RequestParam("request") HttpServletRequest request, @RequestParam("member") Member member);
    ...
    ServerResponse setMemberLabel(@RequestParam("request") HttpServletRequest request, @RequestParam("jsonStr") String jsonStr);
