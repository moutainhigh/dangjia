...
public interface MendOrderAPI {
    ...
    ServerResponse confirmBackMendWorker(@RequestParam("houseId")String houseId,@RequestParam("workerTypeId")String workerTypeId);

    @PostMapping(value = "app/repair/mendOrder/backMendWorkerList")
    @ApiOperation(value = "退人工单明细", notes = "退人工单明细")
    ServerResponse backMendWorkerList(@RequestParam("houseId")String houseId,@RequestParam("workerTypeId")String workerTypeId);
    ...
    ServerResponse backMendWorker(@RequestParam("userToken")String userToken,@RequestParam("houseId")String houseId
            ,@RequestParam("workerGoodsArr")String workerGoodsArr,@RequestParam("workerTypeId")String workerTypeId,@RequestParam("changeOrderId")String changeOrderId);

    @PostMapping(value = "app/repair/mendOrder/confirmMendWorker")
    @ApiOperation(value = "确认补人工", notes = "确认补人工")
    ServerResponse confirmMendWorker(@RequestParam("houseId")String houseId,@RequestParam("workerTypeId")String workerTypeId);

    @PostMapping(value = "app/repair/mendOrder/getMendWorkerList")
    @ApiOperation(value = "补人工单明细", notes = "补人工单明细")
    ServerResponse getMendWorkerList(@RequestParam("houseId")String houseId,@RequestParam("workerTypeId")String workerTypeId);
    ...
    ServerResponse confirmBackMendMaterial(@RequestParam("userToken")String userToken,@RequestParam("houseId")String houseId,
    ...
    ServerResponse backMendMaterialList(@RequestParam("userToken")String userToken,@RequestParam("houseId")String houseId);
    ...
    ServerResponse confirmMendMaterial(@RequestParam("userToken")String userToken,@RequestParam("houseId")String houseId);

    @PostMapping(value = "app/repair/mendOrder/getMendMaterialList")
    @ApiOperation(value = "已添加补材料单明细", notes = "已添加补材料单明细")
    ServerResponse getMendMaterialList(@RequestParam("userToken")String userToken,@RequestParam("houseId")String houseId);
