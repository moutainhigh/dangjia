...
public interface WebMendMaterielAPI {
     ...
     * 通过不通过退货单
     */
    @RequestMapping(value = "web/repair/webMendMateriel/checkMaterialBackState")
    @ApiOperation(value = "审核退货单", notes = "审核退货单")
    ServerResponse checkMaterialBackState(@RequestParam("mendOrderId")String mendOrderId, @RequestParam("state")int state);

    /**
     * 退货单列表
     */
    @RequestMapping(value = "web/repair/webMendMateriel/materialBackState")
     ...
     * 审核补货单
     */
    @RequestMapping(value = "web/repair/webMendMateriel/checkMaterialOrderState")
    @ApiOperation(value = "审核补货单", notes = "审核补货单")
    ServerResponse checkMaterialOrderState(@RequestParam("mendOrderId")String mendOrderId, @RequestParam("state")int state);

    /**
     * 根据mendOrderId查明细
     */
    @RequestMapping(value = "web/repair/webMendMateriel/mendMaterialList")
     ...
     */
    @RequestMapping(value = "web/repair/webMendMateriel/materialOrderState")
