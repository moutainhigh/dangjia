...
public interface HouseWorkerAPI {
    ...
    ServerResponse setWorkerGrab(@RequestParam("userToken")String userToken,@RequestParam("houseFlowId")String houseFlowId);
    ...
    public ServerResponse getConstructionByWorkerId(@RequestParam("userToken")String userToken );

    @PostMapping("app/core/houseWorker/getMyHomePage")
    @ApiOperation(value = "获取我的界面", notes = "获取我的界面")
    public ServerResponse getMyHomePage(@RequestParam("userToken")String userToken );
    ...
    @PostMapping("app/core/houseWorker/telCode")
    @ApiOperation(value = "校验交底二维码", notes = "校验交底二维码")
    public ServerResponse telCode(@RequestParam("userToken")String userToken,@RequestParam("code")String code);

    @PostMapping("app/core/houseWorker/getCheckCode")
    @ApiOperation(value = "校验巡查二维码", notes = "校验巡查二维码")
    public ServerResponse scanCode(@RequestParam("userToken")String userToken,@RequestParam("code")String code,
    ...
    @PostMapping("app/core/houseWorker/getCourse")
    @ApiOperation(value = "施工进程详情", notes = "施工进程详情")
    public ServerResponse getCourse(@RequestParam("userToken")String userToken,@RequestParam("houseFlowId")String houseFlowId);
    ...
    @PostMapping("app/core/houseWorker/getMailList")
    @ApiOperation(value = "通讯录", notes = "通讯录")
    public ServerResponse getMailList(@RequestParam("userToken")String userToken,@RequestParam("houseFlowId")String houseFlowId);
}
