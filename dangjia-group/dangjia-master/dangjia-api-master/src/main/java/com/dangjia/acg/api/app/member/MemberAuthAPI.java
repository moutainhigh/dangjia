...
public interface MemberAuthAPI {
     ...
     * @description 小程序通过Code注册登录账号
     * @method POST
     * @url master/memberAuth/miniProgramCodeRegister
     * @return_param userId string 用户id
     * @return_param phone string 用户电话
     * @return_param userType string 工匠类型(0:大管家；1：普通工匠;2:业主)
     * @return_param workerTypeName string 工匠类型名称
     ...
     * @number 9
     * @Author: Ruking 18075121944
     * @Date: 2020/1/6 10:50 PM
     */
    @RequestMapping(value = "memberAuth/miniProgramCodeRegister", method = RequestMethod.POST)
    @ApiOperation(value = "小程序通过Code注册登录账号", notes = "小程序通过Code注册登录账号")
     ...
     * @return {"res":1000,"msg":{"resultObj":{返回参数说明},"resultCode":1000,"resultMsg":"成功"} }
     * @catalog 当家接口文档/用户模块/第三方认证
     * @title 小程序通过手机号注册登录账号
     * @description 小程序通过手机号注册登录账号
     * @method POST
     * @url master/memberAuth/miniProgramPhoneRegister
     * @return_param userId string 用户id
     * @return_param phone string 用户电话
     * @return_param userType string 工匠类型(0:大管家；1：普通工匠;2:业主)
     * @return_param workerTypeName string 工匠类型名称
     ...
     * @number 10
     * @Author: Ruking 18075121944
     * @Date: 2020/1/6 10:52 PM
     */
    @RequestMapping(value = "memberAuth/miniProgramPhoneRegister", method = RequestMethod.POST)
    @ApiOperation(value = "小程序通过手机号注册登录账号", notes = "小程序通过手机号注册登录账号")
    ServerResponse miniProgramPhoneRegister(@RequestParam("request") HttpServletRequest request,
                                            @RequestParam("phone") String phone,
