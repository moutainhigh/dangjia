...
public interface DjStoreActivityAPI {
    ...
    ServerResponse queryStoreActivityParticipatesList(@RequestParam("pageDTO") PageDTO pageDTO,
                                                      @RequestParam("storeActivityId") String storeActivityId);

    @PostMapping("web/activity/support/query")
    @ApiOperation(value = "参与集福助力列表", notes = "参与集福助力列表")
    ServerResponse queryStoreActivitySupportList(@RequestParam("pageDTO") PageDTO pageDTO,
                                                 @RequestParam("participateId") String participateId);
