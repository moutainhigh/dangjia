...
public interface WebMendWorkerAPI {
    ...
    @PostMapping(value = "web/repair/webMendWorker/checkWorkerBackState")
    ...
    @PostMapping(value = "web/repair/webMendWorker/checkWorkerOrderState")
    ...
    ServerResponse workerOrderState(@RequestParam("houseId")String houseId,@RequestParam("pageNum")Integer pageNum, @RequestParam("pageSize")Integer pageSize);
}
