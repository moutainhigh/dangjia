...
public interface RedPackAPI {
    ...
    ServerResponse discountPage(@RequestParam("request") HttpServletRequest request,
    ...
    ServerResponse submitDiscounts(@RequestParam("request") HttpServletRequest request,
                                   @RequestParam("businessOrderNumber") String businessOrderNumber,
                                   @RequestParam("redPacketRecordIds") String redPacketRecordIds);
    ...
    ServerResponse queryRedPackRecordCount(@RequestParam("request") HttpServletRequest request,
                                           @RequestParam("activityRedPackRecord") ActivityRedPackRecord activityRedPackRecord);
    ...
    ServerResponse queryActivityRedPackRecords(@RequestParam("request") HttpServletRequest request,
                                               @RequestParam("activityRedPackRecord") ActivityRedPackRecord activityRedPackRecord,
    ...
    ServerResponse sendMemberPadPackBatch(@RequestParam("phones") String phones, @RequestParam("redPackId") String redPackId,
                                          @RequestParam("redPackRuleIds") String redPackRuleIds);
}
