...
public class DjSupApplicationProductController implements DjSupApplicationProductAPI {
    ...
    public ServerResponse supplierList(String cityId,  String userId, String productId) {
        return djSupApplicationProductService.supplierList(cityId, userId,productId);
    }

    @Override
    @ApiMethod
    public DjSupApplicationProduct getDjSupApplicationProduct(String cityId, String supplierId, String productId) {
        return djSupApplicationProductService.getDjSupApplicationProduct(cityId,supplierId,productId);
    }
