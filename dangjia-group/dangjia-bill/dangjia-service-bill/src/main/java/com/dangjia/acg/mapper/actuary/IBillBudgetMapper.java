...
public interface IBillBudgetMapper extends Mapper<BudgetMaterial> {
    ...
    //查询已支付精算的总费用
    Double selectTotalPriceByHouseId(@Param("houseId") String houseId,@Param("searchTypeId") String searchTypeId,@Param("steta") Integer steta);
     ...
     * @return
     */
    List<DecorationCostDTO> searchBudgetCategoryLabelList(@Param("houseId") String houseId,@Param("searchTypeId") String searchTypeId);
    /**
     * 精算--分类汇总（按末级分类）
     * @param houseId
     * @param searchTypeId
