package com.dangjia.acg.jmessage.api.common.model.message;
...
public class MessagePayload implements IModel {
    ...
    private cn.jmessage.api.common.model.message.MessageBody mMsgBody;
    private cn.jmessage.api.common.model.message.Notification mNotification;
    ...
    public MessagePayload(Integer version, String targetType, String targetId, String fromType, String fromId,
                          ...
                          boolean noNotification, MessageType msgType, cn.jmessage.api.common.model.message.MessageBody msgBody, cn.jmessage.api.common.model.message.Notification notification) {
