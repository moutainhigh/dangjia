...
public class JMessageConfig {
    ...
    public static final String USER_PATH = "im.member.path";
    public static final String V2_USER_PATH = "im.v2.member.path";
    ...
    public static final String CROSS_USER_PATH = "im.cross.member.path";
