package com.dangjia.acg.jmessage.api;
...
public class JMessageClient {
    ...
    /**
     * Set member's group message blocking
     ...
     * @param targetId target member's id
    ...
    /**
     * Get message list from member's record, messages will store 60 days.
    ...
    /**
     * Get member's message list with cursor, the cursor will effective in 120 seconds.
    ...
    /**
     * Add blacklist whose users belong to another app to a given member.
    ...
    /**
     * Delete blacklist whose users belong to another app from a given member.
     * @param username The owner of the blacklist
     * @param blacklists CrossBlacklist array
     * @return No content
     * @throws APIConnectionException connect exception
    ...
    /**
     * Get all users' info(contains appkey) of member's cross app blacklist
    ...
    /**
     * Get member's whole chat room information
     *
    ...
    /**
     * Update member speak status
     *
     * @param roomId   chat room id
     * @param username member to be modified
    ...
    // ============================   Report v2   VIP Only     ====================
    /**
     * Get member statistic, now time unit only supports DAY
