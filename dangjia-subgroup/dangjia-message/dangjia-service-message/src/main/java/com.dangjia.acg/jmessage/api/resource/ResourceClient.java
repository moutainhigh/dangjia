...
public class ResourceClient extends BaseClient {
     ...
     */
    public cn.jmessage.api.resource.DownloadResult downloadFile(String mediaId)
        ...
        return cn.jmessage.api.resource.DownloadResult.fromResponse(response, DownloadResult.class);
    }
     ...
     * @throws APIRequestException request exception
     */
    public cn.jmessage.api.resource.UploadResult uploadFile(String path, String fileType)
            throws APIConnectionException, APIRequestException {
        ...
        if (file.exists() && file.isFile()) {
            ...
            try {
                ...
                return cn.jmessage.api.resource.UploadResult.fromResponse(wrapper, UploadResult.class);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
