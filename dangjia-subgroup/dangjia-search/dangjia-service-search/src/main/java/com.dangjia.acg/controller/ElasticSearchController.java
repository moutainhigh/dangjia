...
public class ElasticSearchController implements ElasticSearchAPI{
  ...
  @Override
  @ApiMethod
  public String saveESJsonList(List<String> jsonStr,String indexName,String tableTypeName) {
    elasticSearchService.saveESJsonList(jsonStr,indexName,tableTypeName);
