...
public class BusinessOrder extends BaseEntity {
	...
	@Column(name = "type")
	@Desc(value = "支付类型  1工序支付任务,2补货补人工 , 3,充值，4待付款进来只付材料, 5验房分销, 6换货单,7:设计精算补单,9:工人保险，10维保订单，" +
			"11当家贝兑换单,12当家贝充值,13 拼团购,14 限时购")
	@ApiModelProperty("支付类型  1工序支付任务,2补货补人工 , 3,充值，4待付款进来只付材料, 5验房分销, 6换货单,7:设计精算补单,9:工人保险，10维保订单,11当家贝兑换单,12当家贝充值,13 拼团购,14 限时购")
	private Integer type; //支付类型  1工序支付任务,2补货补人工 , 3,充值，4待付款进来只付材料, 5验房分销, 6换货单,7:设计精算补单,9:工人保险，10维保订单，
			//11当家贝兑换单,12当家贝充值,13 拼团购,14 限时购
