...
public class MendOrder extends BaseEntity {
	...
	@Column(name = "type")
	@Desc(value = "类型：（0:补材料;1:工匠补人工;2:退材料(剩余材料登记);3:业主退人工,4:业主退材料;5业主退货退款;6系统自动退款;7业主主动补人工）")
	@ApiModelProperty("类型：（0:补材料;1:工匠补人工;2:退材料(剩余材料登记);3:业主退人工,4:业主退材料;5业主退货退款;6系统自动退款;7业主主动补人工）")
	private Integer type;

	@Column(name = "state")
	@Desc(value = "状态：（0生成中,1处理中,2不通过取消,3已通过(审核通过或已发送供应商）,4已全部结算,5已撤回,6已关闭）")
	@ApiModelProperty("0生成中,1处理中,2不通过取消,3已通过,4已全部结算,5已撤回，6已关闭")
