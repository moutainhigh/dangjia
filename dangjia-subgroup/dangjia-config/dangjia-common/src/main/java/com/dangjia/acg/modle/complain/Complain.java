...
public class Complain extends BaseEntity {
    ...
    @Desc(value = "申述类型 1: 被处罚申诉.2：要求整改.3：要求换人.4:部分收货申诉.5:提前结束装修.6业主要求换人.7:业主申诉部分退货.8工匠申请部分退货.9工匠报销.10工匠申维保定责,12店铺申诉维保定责")
    @ApiModelProperty("申述类型 1: 被处罚申诉.2：要求整改.3：要求换人.4:部分收货申诉.5:提前结束装修.6业主要求换人.7:业主申诉部分退货.8工匠申请部分退货.9工匠报销.10工匠申维保定责,12店铺申诉维保定责")
