...
public class WorkerDetail extends BaseEntity {
    ...
    @Column(name = "state")
    @Desc(value = "0工钱收入,1提现,2自定义增加金额,3自定义减少金额,4退材料退款,5剩余材料退款,6退人工退款,7运费,8提现驳回到余额，9:提前结束装修退款,10滞留金收入，11:滞留金转出,12奖励，13:处罚,14:质保维修扣款")
    @ApiModelProperty("0工钱收入,1提现,2自定义增加金额,3自定义减少金额,4退材料退款,5剩余材料退款,6退人工退款,7运费,8提现驳回到余额，9:提前结束装修退款,10滞留金收入，11:滞留金转出,12奖励，13:处罚, 14:质保维修扣款")
