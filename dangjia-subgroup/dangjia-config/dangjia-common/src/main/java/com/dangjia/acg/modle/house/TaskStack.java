...
public class TaskStack extends BaseEntity {
    ...
    @Column(name = "type")
    @Desc(value = "任务类型0跳转网页，1支付任务,2补货补人工,3审核验收任务,4大管家审核退,5审核工匠,6图纸不合格,7是否提交补差价订单,8工匠缴纳质保金,9责任人通知,10工匠责任通知,11工匠发起退材料")
    @ApiModelProperty("任务类型0跳转网页，1支付任务,2补货补人工,3审核验收任务,4大管家审核退,5审核工匠,6图纸不合格,7是否提交补差价订单,8工匠缴纳质保金,9责任人通知,10工匠责任通知,11工匠发起退材料")
